...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_96_ansi(
        _______,  _______,   _______,   _______,   _______,   _______,   _______,   KC_F13,  KC_F15,   KC_F17,   KC_F19,   KC_F21,   KC_F23,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,   _______,   _______,   _______,   _______,   _______,   KC_F14,  KC_F16,   KC_F18,   KC_F20,   KC_F22,   KC_F24,       _______,      _______,  _______,  _______,  _______,
        ...
        _______, _______, _______,                            _______,                             _______, _______, _______, KC_MEDIA_PREV_TRACK, _______, KC_MEDIA_NEXT_TRACK, _______,                           _______,  _______
    )
};

const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0] =   { ENCODER_CCW_CW(KC_F18, KC_F17) },
